...
/**
 * Error boundary del grupo `(app)` (dashboard, calendario). Captura errores
 * de las páginas y sus componentes hijos, pero no del propio `layout.tsx`
 * del grupo (p.ej. si `requireUser()` falla ahí) — esos los cubre el
